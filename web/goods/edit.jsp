...
<html>
  <head>
    ...
    <link rel="stylesheet" href="goods/lib/bootstrap/css/bootstrap.min.css">
	<link rel="stylesheet" href="goods/font/fonts/iconfont.css">
	<link rel="stylesheet" href="goods/font/fonts/demo.css">
    <link rel="stylesheet" href="goods/css/style.css" id="theme-stylesheet">
    <link rel="shortcut icon" href="favicon.ico">
	<script src="goods/font/fonts/iconfont.js"></script>
    <script src="goods/lib/jquery/jquery.min.js"></script>
    <script src="goods/lib/popper.js/popper.min.js"> </script>
    <script src="goods/lib/bootstrap/js/bootstrap.min.js"></script>
    <script src="goods/lib/jquery.cookie/jquery.cookie.js"> </script>
    <script src="goods/lib/jquery-validation/jquery.validate.min.js"></script>
    <script src="goods/lib/html5shiv/html5shiv.min.js"></script>
    <script src="goods/lib/respond/respond.min.js"></script>
	<title>Beauty商品数据</title>
  </head>
  <body>
    <div class="page">
      <header class="header">
      ...
      <div class="page-content d-flex align-items-stretch"> 
        <nav class="side-navbar">
          ...
          <ul class="list-unstyled">
                <li class="active"><a href="GoodServlet"> <i class="iconfont icon-chaxunyewu"></i>商品数据的查询</a></li>
                <li><a href="goods/add.jsp"> <i class="iconfont icon-add"></i>商品数据的增加</a></li>
          </ul>
        </nav>
                  ...
                  <div class="articles card">
                    ...
                    <div class="card-body no-padding">
                      ...
                      <table class="table table-bordered">
                      	...
                      	<s:forEach var="goods" items="${list}"> 
					      <tr>
					        <td>img/speed/${goods.goods_src}</td>
					        <td>${goods.goods_name}</td>
					        <td>${goods.goods_price }</td>
					        <td><a class="btn btn-default" href="GoodServlet?type=edit&&goods_src=${goods.goods_src}">修改</a></td>
							<td><a class="btn btn-default"  href="GoodServlet?type=delete&&goods_src=${goods.goods_src}">删除</a></td>
					      </tr>
					     </s:forEach>
					     </table>
                    </div>
    ...
    <script src="goods/js/front.js"></script>
  </body>
</html>